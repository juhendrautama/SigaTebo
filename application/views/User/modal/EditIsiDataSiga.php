...
<input hidden type="text" name="idUnitKerja" value="<?php echo $this->session->userdata('idUnitKerja'); ?>">
...
<div class="row">
    ...
    <div class="form-group col-md-4">
        ...
        <input class="form-control" type="number" value="<?php echo $GetDataIdSiga->nilaiData ?>" name="nilaiData"
            required>
    </div>
</div>
<div class="row">
