<div class="modal fade " id="TambahUserUnit" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="adminpanel/Unit/SimpanDataUser" method="POST" enctype="multipart/form-data">
