<div class="modal fade " id="TambahDataSigatbl10" data-backdrop="static" data-keyboard="false" tabindex="-1"
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select required name="jenisData" id="jd" class="form-control" style="width:100%;">
                                ...
                                <option value="Bumil Kek">Bumil Kek</option>
                                <option value="Bumil Risti">Bumil Risti</option>
                            </select>
                        </div>
...
$('#kecamatan').select2({
    dropdownParent: $('#TambahDataSigatbl10'),
