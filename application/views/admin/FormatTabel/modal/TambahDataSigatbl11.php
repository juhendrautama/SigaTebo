<div class="modal fade " id="TambahDataSigatbl11" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
...
<script type="text/javascript">
    $('#kecamatan').select2({
        dropdownParent: $('#TambahDataSigatbl11'),
