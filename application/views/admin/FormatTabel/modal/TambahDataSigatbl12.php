<div class="modal fade " id="TambahDataSigatbl12" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            ...
            <form action="adminpanel/DataSigaAdmin/SimpanDataSiga" method="POST" enctype="multipart/form-data">
                <div class="modal-body ">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-4">
                            <label class="col-form-label"> Usia Pernikahan :</label>
                            <input class="form-control" type="number" value="" name="usiaPernikahan" required>
                        </div>
...
<script type="text/javascript">
    $('#kecamatan').select2({
        dropdownParent: $('#TambahDataSigatbl12'),
