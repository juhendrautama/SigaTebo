            ...
            <form action="adminpanel/DataSigaAdmin/SimpanDataSiga" method="POST" enctype="multipart/form-data">
                <div class="modal-body ">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-4">
                            <label class="col-form-label">Jenis Sekolah :</label>
                            <select required name="jenisSekolah" id="jenisSekolah" class="form-control"
                                style="width:100%;">
                        ...
                        <div class="form-group col-md-4">
                            <label class="col-form-label">Kategori Sekolah :</label>
                            <select required name="kategoriSekolah" id="kategoriSekolah" class="form-control"
                                style="width:100%;">
                                <option value="">Pilih...</option>
...
$('#jenisSekolah').select2({
    dropdownParent: $('#TambahDataSigatbl<?= $GetDataIdJudul->formatTabel ?>'),
    placeholder: "Pilih..."
});

$('#kategoriSekolah').select2({
    dropdownParent: $('#TambahDataSigatbl<?= $GetDataIdJudul->formatTabel ?>'),
    placeholder: "Pilih..."
});
