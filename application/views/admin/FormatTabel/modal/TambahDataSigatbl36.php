                ...
                <div class="modal-body ">
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <select required name="wilayahUnit" id="wilayahUnit" class="form-control"
                                style="width:100%;">
                                <option value="" disabled selected>Pilih Wilayah...</option>
                                <option value="Hakim Pengadilan Negeri">Hakim Pengadilan Negeri</option>
                                <option value="Pejabat Struktural Pada Pengadilan Negeri">Pejabat Struktural Pada
                                    Pengadilan Negeri</option>
                                <option value="Pejabat Fungsional Pada Pengadilan Negeri">Pejabat Fungsional Pada
                                    Pengadilan Negeri</option>
                                <option value="Hakim Pengadilan Agama">Hakim Pengadilan Agama</option>
                                <option value="Pejabat Struktural Pada Pengadilan Agama">Pejabat Struktural Pada
                                    Pengadilan Agama</option>
                                <option value="Pejabat Fungsional Pada Pengadilan Agama">Pejabat Fungsional Pada
                                    Pengadilan Agama</option>
                            </select>
                        </div>
