                ...
                <div class="modal-body ">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input class="form-control" type="number" value="" name="JumlahAnak" required step="any">
                        </div>
                        <div class="form-group col-md-3">
                            <label class="col-form-label">Memiliki Akta :</label>
                            <input class="form-control" type="number" value="" name="MemilikiAkta" required step="any">
                        </div>
