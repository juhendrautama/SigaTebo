<div class="modal fade " id="TambahDataSigatbl8" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            ...
            <form action="adminpanel/DataSigaAdmin/SimpanDataSiga" method="POST" enctype="multipart/form-data">
                <div class="modal-body ">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            <label class="col-form-label"> Jenis Presentasi :</label>
                            <select required name="jenisPresentasi" id="jp" class="form-control" style="width:100%;">
                                <option value="" disabled selected>Pilih Jenis...</option>
                                <option value="Eklamsia">Eklamsia</option>
                                <option value="Infeksi">Infeksi</option>
                                <option value="Aburtus">Aburtus</option>
                                <option value="P_Lama_Macet">P.Lama/Macet</option>
                                <option value="Emboli Obstertri">Emboli Obstertri</option>
                                <option value="Kompi Masa PuePureum">Kompi Masa PuePureum</option>
...
<script type="text/javascript">
    $('#kecamatan').select2({
        dropdownParent: $('#TambahDataSigatbl8'),
