...
<?php $this->load->view('admin/FormatTabel/modal/TambahDataSigatbl18');
?>
<hr>
    ...
    <tbody>
        ...
        foreach ($tampilsiga->result() as $row) { ?>
            <tr>
                ...
                <td>
                    <center>
                        <a href="adminpanel/DataSigaAdmin/HapusDataSiga/<?php echo $row->idSiga18; ?>/<?php echo $row->idUnitKerja; ?>/<?php echo $row->idKategoriData; ?>/<?php echo $row->idJudulData; ?>" class="btn btn-warning btn-sm elevation-1">
                            <i class="nav-icon fas fa-trash"></i>
                        </a>
                        <!-- <a href="#" class="btn btn-primary btn-sm elevation-1" data-toggle="modal" data-target="#editDataKetegori" data-id='<?php echo $row->idSiga18; ?>'>
