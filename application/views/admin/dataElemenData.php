...
<body class="hold-transition sidebar-mini">
                ...
                <div class="container-fluid">
                    <div class="card shadow">
                        <div class="card-header">
                            <a href="adminpanel/DataSigaAdmin/Data/<?= $GetDataIdUnit->idUnitKerja ?>/<?= $GetDataIdKategori->idKategoriData ?>/<?= $GetDataIdJudul->idJudulData ?>"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td align="center">
                                            ...
                                            <a href="adminpanel/DataSigaAdmin/HapusElemenData/<?php echo $row->idElemenData; ?>/<?php echo $row->idUnitKerja; ?>/<?php echo $row->idKategoriData; ?>/<?php echo $row->idJudulData; ?>"
                                                onclick="return confirm('Apakah yakin ingin dihapus?');"
                                                class="btn btn-warning btn-sm elevation-1">
                                                <i class="nav-icon fas fa-trash"></i>
                                            </a>
                                            <?php } else { ?>
                                            <a href="" data-toggle="modal" data-target="#PesanHapus"
                                                data-id='<?php echo $row->idElemenData; ?>'
                                                class="btn btn-danger btn-sm elevation-1">
                                                <i class="nav-icon fas fa-trash"></i>
                                            </a>
                                            <?php } ?>
                                            <a href="#" class="btn btn-success btn-sm elevation-1" data-toggle="modal"
                                                data-target="#editElemendata"
                                                data-id='<?php echo $row->idElemenData; ?>'>
    ...
    <!-- Modal Hapus -->
    <div class="modal fade " id="PesanHapus" data-backdrop="static" data-keyboard="false" tabindex="-1"
    ...
    <!-- Modal data -->
    <div class="modal fade " id="editElemendata" data-backdrop="static" data-keyboard="false" tabindex="-1"
        aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog ">
            <div class="modal-content ">
                <div class="modal-header">
                ...
                <form action="adminpanel/DataSigaAdmin/SimpanUbahElemenData" method="POST">
...
$('#editElemendata').on('show.bs.modal', function(e) {
    ...
    $.ajax({
        type: 'post',
        url: "<?php echo base_url(); ?>adminpanel/DataSigaAdmin/GetElemenDataId",
        data: {
            id: id
        },
        success: function(data) {
