                ...
                <div class="container-fluid">
                    <div class="card shadow">
                        <div class="card-header">
                            ...
                            <center>
                                <h5><b>Data Ketegori </b></h5>
                            </center>
                        </div>

                        <div class="card-body ">
                            <a href="#" class="btn btn-success btn-sm elevation-1" data-toggle="modal" data-target="#TambahKategori">
                                <i class="nav-icon  fas fa-plus"></i> Tambah Data
                            </a>

                            <?php $this->load->view('admin/modal/TambahKategori'); ?>
                            ...
                            <table id="example" class="table table-bordered table-hover display" style="font-size:14px; width: 100%;">
                                ...
                                <tbody>
                                    <?php $no = 1;
                                    foreach ($GetKategoriAll->result() as $row) { ?>
                                        <tr>
                                            <td><?php echo $no; ?></td>
                                            ...
                                            <td align="center">
                                                <!-- <a href="adminpanel/KategoriData/HapusDatak/<?php echo $row->idKategoriData; ?>"
                                                onclick="return confirm('Apakah yakin ingin dihapus?');"
                                                class="btn btn-warning btn-sm elevation-1">
                                                <i class="nav-icon fas fa-trash"></i>
                                            </a> -->
                                                <a href="#" class="btn btn-primary btn-sm elevation-1" data-toggle="modal" data-target="#editDataKetegori" data-id='<?php echo $row->idKategoriData; ?>'>
