<div class="modal fade " id="TambahElemenData" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="adminpanel/DataSigaAdmin/SimpanElemenData" method="POST" enctype="multipart/form-data">
                <div class="modal-body ">

                    <div class="row">
                        <div class="form-group col-md-12">
                            <input hidden type="text" name="idUnitKerja" value="<?= $GetDataIdUnit->idUnitKerja ?>">
