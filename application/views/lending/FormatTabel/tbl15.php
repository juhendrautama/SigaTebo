<table id="example" class="table table-bordered table-hover " style="font-size:12px; width: 100%;">
    <thead>
        <tr>
            ...
            <th style="text-align: center; vertical-align: middle;" colspan="6">SD/MI</th>
            <th style="text-align: center; vertical-align: middle;" colspan="6">SLTP/MTS</th>
            <th style="text-align: center; vertical-align: middle;" colspan="6">SMA/SMK/MA</th>
        </tr>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><?= $jumSD_MI_2022 = $total_nilai_SD_MI_2022_P + $total_nilai_SD_MI_2022_L ?></td>
            <!-- total l -->
            ...
            <td><?= $jumSLTP_MTS_2022 = $total_nilai_SLTP_MTS_2022_L + $total_nilai_SLTP_MTS_2022_P ?></td>
            <!-- total l -->
            ...
            <td><?= $jumSMA_SMK_MA_2022 = $total_nilai_SMA_SMK_MA_2022_L + $total_nilai_SMA_SMK_MA_2022_P ?></td>
            <!-- total l -->
            <td><?= $jumSMA_SMK_MA_2023 = $total_nilai_SMA_SMK_MA_2023_P + $total_nilai_SMA_SMK_MA_2023_P ?></td>
        </tr>
        <?php $no++;
        } ?>
    </tbody>
